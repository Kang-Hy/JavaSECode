...
public class DateTimeTest {
    ...
    * */
    ...
    public void test5(){
        ...
        DateTimeFormatter datatemp = DateTimeFormatter.ofPattern("yyyy/MM/dd HH:mm:ss");

        //格式化：日期、时间-->字符串
        LocalDateTime localDateTime = LocalDateTime.now();
        String strDateTime = datatemp.format(localDateTime);
        System.out.println(strDateTime);//2022/12/05 16:04:44

        //解析：字符串 ---> 日期、时间
        TemporalAccessor temporalAccessor = datatemp.parse("2022/12/05 15:04:44");
